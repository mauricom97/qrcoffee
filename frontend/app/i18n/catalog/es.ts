...
export const esMessages = {
  ...
  notifications: {
    ...
    panelAria: "Lista de notificaciones",
    panelTitle: "Notificaciones",
    markAllRead: "Marcar todas como leídas",
    empty: "No hay notificaciones recientes.",
    open: "Abrir",
    newOrderTitle: "Nuevo pedido",
    newOrderDetail: "Hay un nuevo pedido pendiente.",
    ordersActivityTitle: "Pedidos actualizados",
    ordersActivityDetail: "Cambió el estado de algún pedido.",
    attendantTitle: "Cliente llama",
    attendantDetail: "Mesa {table} pide atención.",
