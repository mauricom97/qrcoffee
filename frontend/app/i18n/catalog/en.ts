...
export const enMessages = {
  ...
  notifications: {
    ...
    panelAria: "Notification list",
    panelTitle: "Notifications",
    markAllRead: "Mark all as read",
    empty: "No recent notifications.",
    open: "Open",
    newOrderTitle: "New order",
    newOrderDetail: "A new order was added to the queue.",
    ordersActivityTitle: "Orders updated",
    ordersActivityDetail: "Order status changed in the kitchen.",
    attendantTitle: "Guest calling",
    attendantDetail: "Table {table} is asking for staff.",
    attendantDetailWithNote: "Table {table}: {message}",
  },
  language: {
    label: "Language",
    pt: "Português",
