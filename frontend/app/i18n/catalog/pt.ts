...
export const ptMessages = {
  ...
  notifications: {
    ...
    panelAria: "Lista de notificações",
    panelTitle: "Notificações",
    markAllRead: "Marcar todas como lidas",
    empty: "Nenhuma notificação recente.",
    open: "Abrir",
    newOrderTitle: "Novo pedido",
    newOrderDetail: "Um novo pedido entrou na fila (pendente).",
    ordersActivityTitle: "Pedidos atualizados",
    ordersActivityDetail: "Houve alteração no status dos pedidos.",
    attendantTitle: "Cliente chamando",
    attendantDetail: "Mesa {table} pediu atenção.",
    attendantDetailWithNote: "Mesa {table}: {message}",
  },
  language: {
    label: "Idioma",
    pt: "Português",
